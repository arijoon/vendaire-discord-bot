...
helpContent.usage += `${indent}bullshit                     \tPost a lol pic \n`
helpContent.usage += `${indent}memri                        \tPost a lol pic \n`
helpContent.usage += `${indent}yousmart                     \tPost a lol pic \n`
helpContent.usage += `${indent}randomPic                    \tPost a lol pic \n`
...
helpContent.usage += `${indent}has{somethings} {text}       \tRandomize whether something does text\n`
helpContent.usage += `${indent}have{somethings} {text}      \tRandomize whether something does text\n`
